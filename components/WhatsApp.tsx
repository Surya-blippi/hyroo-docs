...
// Inline text link, e.g. inside a footer or a help line.
export function WhatsAppLink({
  ...
  return (
    <a
      ...
      className={`inline-flex items-center gap-1.5 font-medium text-[#25D366] transition-opacity hover:opacity-80 ${className}`}
    >
